...
- генерация аудио проповеди: передаем системные инструкции и промпт и контекс (всю проповедь) и просим написать вю проповедь только уже выравненную и в красивом формате (тоже полследловательность мыслей, но при оходит по звучанию текста/)
...
Эта фича значительно улучшит пользовательский опыт работы с Dashboard:
