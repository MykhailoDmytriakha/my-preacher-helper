...
// Live OS-theme following (matchMedia 'change' + device-wake retries) now lives in
// `ThemeWatcher`; this hook only owns the preference state, persistence and
// applying the theme when the preference itself changes. Those behaviours are
// covered in `ThemeWatcher.test.tsx`.
