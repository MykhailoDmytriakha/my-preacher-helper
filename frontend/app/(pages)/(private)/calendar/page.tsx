...
export default function CalendarPage() {
    ...
    const sermonsForSelectedDate = sermonsByDate[selectedDateStr] || [];
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                            ...
                            <div className="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-xl border border-blue-100 dark:border-blue-800/50">
                                ...
                                <div className="space-y-2">
                                    <div className="flex justify-between text-xs">
                                        <span className="text-blue-600 dark:text-blue-400">Total Preachings</span>
                                        <span className="font-bold text-blue-900 dark:text-blue-100">
                                            {sermons.flatMap(s => s.preachDates || []).length}
                                        </span>
                                    </div>
                                    <div className="flex justify-between text-xs">
                                        <span className="text-amber-600 dark:text-amber-400">Pending Date Entry</span>
                    ...
                    <div className="lg:col-span-2">
                        {isLoading ? (
                            ...
                            <DateEventList
                                date={selectedDate}
                                sermons={sermonsForSelectedDate}
                            />
                        )}
                    </div>
                </div>
