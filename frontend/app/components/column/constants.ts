export const TRANSLATION_STRUCTURE_ADD_THOUGHT = "structure.addThoughtToSection";
...
export const BG_GRAY_LIGHTER_DARK = "bg-gray-100 dark:bg-gray-700";
export const INLINE_EDIT_ACTION_BUTTON_BASE_CLASS =
  "p-1 flex-shrink-0 bg-white/50 dark:bg-black/20 rounded transition-colors";

export const POINT_AUDIO_SECTION_IDS = ["introduction", "main", "conclusion"] as const;
export const SECTION_NAV_ORDER = ["introduction", "main", "conclusion"] as const;
export const OUTLINE_SAVE_DEBOUNCE_MS = 200;
