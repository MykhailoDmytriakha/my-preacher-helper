...
const SermonActionsMenu: React.FC<SermonActionsMenuProps> = ({
  ...
  return (
    <>
          ...
          <div className="absolute right-0 mt-2 w-60 bg-white dark:bg-gray-800 rounded-md shadow-lg z-50 border border-gray-200 dark:border-gray-700">
            <div className="p-2">
              ...
              <div className="mb-2 pb-2 border-b border-gray-200 dark:border-gray-700">
                ...
                {/* Placeholder buttons for PDF/Word */}
                <button
      ...
      {/* Conditionally render ExportButtons container (which includes the modal) */}
      {showTxtModal && (
          <ExportButtons
              sermonId={sermon.id}
              getExportContent={generateExportContent}
              showTxtModalDirectly={true}
              onTxtModalClose={handleCloseModal}
          />
      )}
    </>
  );
