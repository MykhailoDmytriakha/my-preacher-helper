    ...
    <div className="p-4 sm:p-6 bg-white dark:bg-gray-800 rounded-lg shadow border border-gray-200 dark:border-gray-700">
      ...
      <div className="space-y-3 sm:space-y-4">
        ...
        <div className="flex flex-row text-xs sm:text-sm min-h-[120px] overflow-hidden" style={{ display: 'flex', flexDirection: 'row' }}>
          <div className="flex-1 flex flex-col items-center text-center px-2 min-w-0" style={{ color: introColor, flex: '1 1 0%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div className="flex-1 flex flex-col items-center text-center px-2 min-w-0" style={{ color: mainColor, flex: '1 1 0%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
          ...
          <div className="flex-shrink-0 self-stretch w-px bg-gray-200 dark:bg-gray-700 mx-1 sm:mx-2" style={{ flexShrink: 0, alignSelf: 'stretch' }} />
          <div className="flex-1 flex flex-col items-center text-center px-2 min-w-0" style={{ color: conclusionColor, flex: '1 1 0%', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
