...
export function createThoughtUserMessage(
  ...
  return `
    ...
    ВАЖНО:
    - КРИТИЧЕСКИ ВАЖНО: СОХРАНЯЙТЕ СТИЛЬ ГОВОРЯЩЕГО! Не меняйте разговорный стиль на литературный. Не делайте текст более "правильным" или формальным. Оставляйте индивидуальные выражения и фразы говорящего как есть.
